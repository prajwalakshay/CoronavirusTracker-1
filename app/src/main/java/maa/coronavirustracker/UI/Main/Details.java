...
public class Details extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialToolbar = findViewById(R.id.toolbardetails);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.notification:
                        NewsDialog newsDialog = new NewsDialog(Details.this);
                        newsDialog.getWorldNews();
                        break;
                    case R.id.helpingHand:
                        ServiceDialog serviceDialog = new ServiceDialog(Details.this);
    ...
    private void setAllData() {
        ...
        changeColorOfString(activityDetailsBinding.Cases, "• Cases : ", String.format("%,d", (Integer.parseInt(Cases))), getResources().getColor(R.color.TodayCasesColor));
        ...
        changeColorOfString(activityDetailsBinding.TodayDeaths, "• Today deaths : ", String.format("%,d", (Integer.parseInt(TodayDeaths))), getResources().getColor(R.color.TodayDeathsColor));
